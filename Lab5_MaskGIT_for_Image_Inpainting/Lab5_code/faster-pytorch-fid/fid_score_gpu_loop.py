...
def main():
    ...
    for step in range(1,20):
        print(args.predicted_path+str(step)+'/')
        predicted_path = args.predicted_path+str(step)+'/'
        fid_value = calculate_fid_given_paths(predicted_path,args.gtcsv_path,
                                            args.batch_size,
                                            device,
                                            args.dims,
                                            num_workers)
    ...
    path_name = os.path.join('/mnt/left/home/2023/angelina/DLCourse/Lab5/', args.saveoutname)
    np.save(path_name, FIDs_array)
...
parser.add_argument('--saveoutname', type=str, default="my_array.npy")
